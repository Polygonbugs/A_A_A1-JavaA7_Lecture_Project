 ...
 *          - 입금/출금구분은 입금의 경우 'I', 출금의 경우 'O'롷 사용합니다.
...
CREATE TABLE 가계부(
    ...
    , 입출금구분   CHAR(1)     CONSTRAINT 가계부_입출금구분_CK   CHECK(입출금구분 in ('I', 'O'))
    , 금액       NUMBER      DEFAULT(0)
...
INSERT INTO 가계부 VALUES(5, 'O', 5500, TO_DATE('20220115'), '0000E', '종이컵(소) 30개');
