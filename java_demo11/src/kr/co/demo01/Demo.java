...
public class Demo {
    public static void main(String[] args) {
         ...
         *
         *   - ArrayList
         *      - List의 구현체로 초기 저장 용량 10에서 데이터가 추가 / 삭제
         ...
         *        삭제 작업이 이루어지는 겨우 성능이 가장 우수한 컬렉션이다.
         */
        ...
        //boolean isExists = aList.contains(60);
        ...
        // 전체 탐색
        // 기존 for 문 이용 : 하나 하나 배열의 형태로 확인하는 것
