...
public class Demo {
    public static void main(String[] args) {
         ...
         *          - 바이트기반스트림은 데이터 입/출력에 사용하는 데이터가 바이트 자료형으로 이루어짐.
         *            (이미지, 영상, 실행파일 등의 바이트기반 데이터를 입출력 할 때 사용/ .docx, .hwp)
         *          - 문자기반스트림은 입/출력에 사용하는 데이터가 문자 자료형으로 이루어짐.
